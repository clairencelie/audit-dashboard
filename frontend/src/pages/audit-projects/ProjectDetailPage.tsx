...
type Tab = 'overview' | 'audit-program' | 'checklists' | 'daily-effort' | 'working-papers' | 'data-requests' | 'reference-docs' | 'findings'
  ...
  return (
    <div>
      ...
      <div className="p-6 space-y-6">
        ...
        {activeTab === 'findings' && <FindingsTab project={project} />}
      </div>
    </div>
  )
}
